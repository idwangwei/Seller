<template>
  <div class="app-container">
    <el-row>
      <el-col :span="12">
        <el-button
          ...
          @click="getMaxConnectionList"
        >获取联系最多</el-button>
        <el-button
          type="primary"
          icon="el-icon-search"
          :loading="interestLoading"
          @click="getMaxInterestList"
        >获取收藏最多</el-button>
      </el-col>
      <el-col :span="12">
    ...
    <el-table
      v-loading="connectionLoading||interestLoading||listLoading"
      :data="list"
