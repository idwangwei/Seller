...
import {
    getCommodityDecorativeList,
    getCommoditySpecificationList
} from "@/api/commodity";
...
export default {
    ...
    watch: {
        "form.brandId": function(val, oldVal) {
            ...
            getCommoditySpecificationList({ brandId: this.form.brandId }).then(
                resp => {
                    this.specificationList = resp.data;
                }
            );
            getCommodityDecorativeList({ brandId: this.form.brandId }).then(
                resp => {
